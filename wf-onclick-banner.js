...
class LGBTQModal {
  ...
  closeModalEvent(modal) {
    const maxAge = this.showOnlyOnce ? 60 * 60 * 24 * 1e3 : 1;
    const now = Date.now();
...
let lgbtqModal = new LGBTQModal();
function showBanner() {
  console.log("show", lgbtqModal);
  lgbtqModal.dispose();
  lgbtqModal = new LGBTQModal();
  lgbtqModal.show();
}
